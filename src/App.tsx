	...
	return (
        <div className='app'>
            ...
            <div className='quick-links'>
                <div className="title">Conceptualizing the Design and Use of Augmented Reality Within a Common Operating Picture for Incident Command Systems - Artifacts, Deliverables, and Reports</div>
                <div className="links">
